...
public interface ArithmeticExpressionsVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link ArithmeticExpressionsParser#minus}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMinus(@NotNull ArithmeticExpressionsParser.MinusContext ctx);
	...
	/**
	 * Visit a parse tree produced by {@link ArithmeticExpressionsParser#power}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPower(@NotNull ArithmeticExpressionsParser.PowerContext ctx);
